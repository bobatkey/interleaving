...
\autoref{sec:coproducts-with-free-monads}, where we will see that
...
$(\mu(\mathit{ListF}~a), \mathit{in})$ exists, and we write $\fold{-}$
for the unique homomorphism induced by initiality. We can define
$\mathit{append}$ in terms of $\fold{-}$ as:
\begin{displaymath}
  \begin{array}{l}
...
impossible to express this requirement in Haskell's type system.
...
interpreting its consistuent parts. Coproducts of monads are precisely
