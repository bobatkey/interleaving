...
Gonzalez proves several properties of the $\mathit{Proxy}$ types
...
Iteratees, we could observe that $\mathit{Proxy}$ is an instance of
interleaved data and effects, and reformulate Gonzalez's proofs using
...
the result that $\mathit{Proxy}~a'~a~b'~b~m~r$ follows.
