...
preceding~\cite{fs07} did not derive induction rules or other proof
principles for effectful datatypes. However, Filinski and St\o{}vring
give a principle of {\em proof by rigid induction} for such datatypes
that is a variant of those of both Lehmann and Smyth~\cite{ls81}, and
of Crole and Pitts~\cite{cp92}. It supports the same kind of inductive
reasoning, again in the specific category and for the specific
functors with which they work, that we show initial
