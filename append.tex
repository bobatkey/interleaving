...
general functional programming audience, without the heavy
category-theoretic prerequisites of our previous work.
...
coproduct of a free monad and an arbitrary monad. This construction
builds on the general foundation of initial $f$-and-$m$-algebras.
...
% Fokkinga and Pardo separately derive theories and proof principles for
% effectful structural recursion over \emph{pure} data. By contrast, in
% this paper we wish to explore computation and reasoning with
% \emph{effectful} data, where data and effects are interleaved.
